            ...
            <div class="container ">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-sm-7">
                        ...
                        @if ($buku->stok > 0)
                            @if ($pinjaman_user)
                                <span class="alert alert-danger">Pinjaman bisa dilakukan setelah pinjaman sebelumnya
                                    selesai</span>
                            @else
                                <div class="form">
                                    <form action="{{ URL::to('/simpan_ke_keranjang') }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <input required placeholder="Jumlah hari" type="number" name="jml_hari"
                                                    id="jml_hari" class="form-control" size="1" max="7"
                                                    min="1">
                                            </div>
                                            <div class="col-sm-4">
                                                <input required placeholder="Jumlah buku" type="number" name="jml_buku"
                                                    id="jml_buku" class="form-control" size="1"
                                                    max="{{ $buku->stok }}" min="1">
                                            </div>
                                            <div class="col-sm-4">
