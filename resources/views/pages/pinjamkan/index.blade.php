                    ...
                    <div class="card-header d-flex  justify-content-between">
                        ...
                        <div class="table-tools d-flex justify-content-around ">
                            ...
                            @if ($headerTitle != 'Peminjaman')
                                <a href="{{ URL::to('/admin/cetak_pengembalian') }}" class="btn btn-primary"><i
                                    ...
                                    <tr>
                                        ...
                                        @if ($headerTitle == 'Peminjaman')
                                            <td>
                                                ...
                                                ?>
                                                <a href="https://web.whatsapp.com/send?phone={{ $noHp }}&text={{ $message }}"
                                            ...
                                            <div class="btn-group dropleft btn-option">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a data-detail='@json($row)'
                                                        data-kategori='@json($row->buku->kategori)'
                                                        data-path={{ asset('data/gambar_buku/' . $row->buku->gambar) }}
