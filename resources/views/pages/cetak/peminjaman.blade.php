...
<body>
    <div class="container">
        <div class="header clearfix">
            <div class="logo">
                <img src="{{ 'data:image/png;base64,' . base64_encode(file_get_contents('img/smak.png')) }}"
                    alt="image" width="100">
            </div>
            <div class="header-text">
                <br>
                <h4>Perpustakaan SMKN 7 </h4>
                <p>Makassar, Indonesia, Erth, Balanakang, Jagong, Kec. Pangkajene, Kabupaten Pangkajene Dan Kepulauan,
                    Sulawesi Selatan 90612
                </p>
            </div>
        </div>
                ...
                @foreach ($buku as $row)
                    <tr>
                        ...
                        <td class="align-middle">
                            {{ $jmlTerlambat < 0 ? '0' : 'Rp. ' . number_format($jmlTerlambat * 500) }} </td>
                    </tr>
                @endforeach
            </tbody>
        </table>
