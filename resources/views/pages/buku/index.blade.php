                            ...
                            <tbody>
                                @foreach ($buku as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn-unlihat btn btn-danger" style="display: none"><i
                                        ...
                                        <td class="option">
                                            <div class="btn-group dropleft btn-option">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a data-detail='@json($row)'
                                                        data-kategori='@json($row->kategori)'
                                                        data-path={{ asset('data/gambar_buku/' . $row->gambar) }}
                                                        data-toggle="modal" data-target="#modalPreview"
                                                        class="dropdown-item detail" href="#"><i class="fas fa-info">
                                                            Detail</i></a>
                                                    <a data-edit='@json($row)' data-toggle="modal"
                                                        data-target="#modalPengguna" class="dropdown-item edit"
                                                        href="#"><i class="fas fa-pen"> Edit</i></a>
                                                    <a data-id="{{ $row->id_buku }}" class="dropdown-item hapus"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="main-body">
                    <form id="formbuku" action="{{ URL::to('/admin/create_buku') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input readonly value="" required type="text" class="form-control" name="kode_buku"
                                id="kode_buku">
                        </div>
                        <div class="form-group">
